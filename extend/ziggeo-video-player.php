...
//
//	This file creates the Ziggeo Video Player field
//
...
class Ziggeo_GF_VideoPlayer extends GF_Field {

	public $type = 'ZiggeoVideoPlayer';
	public $type_title = 'Video Player';
	public $simple_type = 'videoplayer';
	...
	function get_form_editor_field_settings() {
		return array(
			...
			'description_setting',
			'rules_setting',
			'ziggeogravityforms_' . $this->simple_type . '_videotoken_setting',
	...
	public function get_form_editor_inline_script_on_page_render() {
		...
		$fields = array(
			array(
				'name'	=> 'ziggeogravityforms_' . $this->simple_type . '_videotoken_setting',
				'value'	=> '',
				'type'	=> 'input'
			),
			array(
	...
	public function get_field_input( $form, $value = '', $entry = null ) {
		...
		$field .= '<div id="' . $field_id . '_placeholder" class="' . $class . '" ' . $tabindex . ' ' . $logic_event . ' ' . $placeholder_attribute . ' ' . $invalid_attribute . ' ' . $disabled_text . '>';
			...
			if($field_data['ziggeogravityforms_' . $this->simple_type . '_videotoken_setting'] !== '') {
				$field .=	'ziggeo-video="' . $field_data['ziggeogravityforms_' . $this->simple_type . '_videotoken_setting'] . '" ';
			}
